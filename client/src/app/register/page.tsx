  ...
  return (
    <div className="min-h-screen bg-white flex flex-col items-center justify-start pt-8">
      ...
      <div className="w-full max-w-[350px] border border-amzn-border-primary rounded-amzn-md p-5">
        <h1 className="text-[28px] font-normal text-amzn-text-primary mb-3">Create account</h1>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <Input
            ...
            required
            error={password && password.length < 6 ? 'Passwords must be at least 6 characters' : undefined}
          />
        ...
        <div className="relative my-4">
          ...
          <div className="relative flex justify-center text-xs">
            <span className="bg-white px-2 text-amzn-text-secondary">Already have an account?</span>
          </div>
        </div>
